...
- **MUST persist to `.agent/context/{session-id}/infrastructure-terraform-analyst.md`**
...
Persist comprehensive Terraform analysis to `.agent/context/{session-id}/infrastructure-terraform-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with module count, state management status, security issues (hardcoded secrets count), and artifact reference.
