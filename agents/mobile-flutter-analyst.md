...
- **MUST persist to `.agent/context/{session-id}/mobile-flutter-analyst.md`**
...
Persist comprehensive Flutter analysis to `.agent/context/{session-id}/mobile-flutter-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with Flutter version, state management approach, top performance issue (widget rebuilds, const usage, ListView), and artifact reference.
