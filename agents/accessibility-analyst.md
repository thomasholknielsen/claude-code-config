...
- **MUST persist findings to `.agent/context/accessibility-*-{session-id}-*.md`** - Required for main thread access
...
Save comprehensive analysis to `.agent/context/accessibility-analysis-{session-id}-{YYYY-MM-DD-HHMMSS}.md`
