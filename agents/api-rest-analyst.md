...
- **MUST persist findings to `.agent/context/{session-id}/api-rest-analyst.md`** - Required for main thread access
...
Persist comprehensive API analysis to `.agent/context/{session-id}/api-rest-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with API style, critical design issues, top recommendation, and artifact reference.
