...
- **MUST persist to `.agent/context/{session-id}/api-graphql-analyst.md`**
...
Persist comprehensive GraphQL analysis to `.agent/context/{session-id}/api-graphql-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with schema quality, N+1 issues (with speedup potential), dataloader recommendations, and artifact reference.
