...
Persist comprehensive database analysis to `.agent/context/{session-id}/database-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with critical issues, top priority optimizations, and artifact reference.
