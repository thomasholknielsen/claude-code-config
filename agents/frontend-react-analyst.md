...
- **MUST persist findings to `.agent/context/{session-id}/frontend-react-analyst.md`** - Required for main thread access
...
Persist comprehensive React analysis to `.agent/context/{session-id}/frontend-react-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with hooks optimization, React 18+ adoption, Server Component insights, and artifact reference.
