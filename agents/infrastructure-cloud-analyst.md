...
- **MUST persist to `.agent/context/{session-id}/infrastructure-cloud-analyst.md`**
...
Persist comprehensive cloud infrastructure analysis to `.agent/context/{session-id}/infrastructure-cloud-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with provider, resource counts, top cost savings opportunity (% and $ estimate), and artifact reference.
