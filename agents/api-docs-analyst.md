...
- **MUST persist to `.agent/context/{session-id}/api-docs-analyst.md`**
...
Persist comprehensive API documentation automation analysis to `.agent/context/{session-id}/api-docs-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with spec completeness, SDK generation status, automation gaps, and artifact reference.
