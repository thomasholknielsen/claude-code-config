...
- **MUST persist to `.agent/context/{session-id}/infrastructure-devops-analyst.md`**
...
Persist comprehensive DevOps analysis to `.agent/context/{session-id}/infrastructure-devops-analyst.md` using XML-tagged structure. Return concise 2-3 sentence summary with pipeline type, top optimization (build time improvement estimate), Docker/K8s issues, and artifact reference.
